// src/data/galleryIndex.js
// Updated: 2026-07-06
// Keys renamed to match flat route paths in siteMap.js
// GalleryRoute eliminated — galleries consumed directly by page components
...
export const galleryIndex = {
  ...
  "foundation": [
    ...
    { id: "img002", imageUrl: "/images/img-2-foundation.webp", title: "initial view south 2", shortAnnotation: "excavated north foundation wall", fullAnnotation: "original foundation wall - no damp-proofing" },
    ...
    { id: "img004", imageUrl: "/images/img-4-foundation.webp", title: "foundation coating prep", shortAnnotation: "foundation coating prep", fullAnnotation: "clear debris from foundation wall" },
  ...
  "party-walls": [
    ...
    { id: "img003", imageUrl: "/images/img-3-party-walls.webp", title: "Party wall: double stud walls separated by an inch", shortAnnotation: "new walls separating kitchens and entries", fullAnnotation: "The new party wall framing for the kitchen and entries is a pair of 2x4 stud walls, separated by 1 in." },
    { id: "img005", imageUrl: "/images/img-5-party-walls.webp", title: "Party walls for new bathrooms - staggered stud wall with 'resilient channel'", shortAnnotation: "party walls for new bathrooms", fullAnnotation: "The new party wall for bathrooms is a 2x8 staggered stud wall with two layers of 5/8 in drywall on one side and two layers of 5/8 in drywall over a layer of resilient channel RC-1 on the other side" },
    { id: "img004", imageUrl: "/images/img-4-party-walls.webp", title: "Insulation for double stud walls at kitchen", shortAnnotation: "insulated with Roxul Safe-n-Sound with two layers of 5/8 in.", fullAnnotation: "each wall insulated with Roxel Safe and Sound cavity insulation" },
    { id: "img011", imageUrl: "/images/img-11-party-walls.webp", title: "Staggered stud walls and double stud walls between bathrooms", shortAnnotation: "staggered stud wall with separation between bathrooms", fullAnnotation: "staggered stud wall with separation between bathrooms. all penetrations sealed with acoustical caulk" },
    { id: "img006", imageUrl: "/images/img-6-party-walls.webp", title: "Bathroom walls with resilient channel", shortAnnotation: "bathroom walls with cavities filled Roxul, framing isolated with resilient channel", fullAnnotation: "Bathroom walls with cavities insulated with Roxul Safe and Sound batts, then a layer of Clark-Dietrich RC-1 resilient channel." },
    { id: "img007", imageUrl: "/images/img-7-party-walls.webp", title: "Layer 1 of 5/8 in. fireblock drywall between kitchens", shortAnnotation: "Layer 1 of 5/8 in. drywall at kitchen", fullAnnotation: "Layer 1 of 5/8. in fireblock drywall at kitchen viewed from Unit 1. All joints were caulked with acoustical sealant" },
    { id: "img008", imageUrl: "/images/img-8-party-walls.webp", title: "Layer 1 of 5/8 in fireblock drywall at bathroom", shortAnnotation: "Layer 1 of 5/8 in fireblock drywall at bathrooms", fullAnnotation: "Layer 1 of 5/8 in fireblock drywall with screws and joints caulked and filled; viewed from Unit 1." },
    { id: "img009", imageUrl: "/images/img-9-party-walls.webp", title: "Layer 2 of 5/8 in. drywall with QuietGlue at kitchen", shortAnnotation: "Layer 2 of 5/8 in fireblock drywall with QuietGlue", fullAnnotation: "Layer 2 of 5/8 in fireblock drywall with QuietGlue Pro applied to back of each drwall sheet for additional sound dampening." },
    { id: "img010", imageUrl: "/images/img-10-party-walls.webp", title: "Layer 2 of 5/8 in fireblock drywall at bathrooms", shortAnnotation: "layer 2 of 5/8 in fireblock drywall at bathrooms", fullAnnotation: "layer 2 of 5/8 in fireblock drywall at the new interior bathroom viewed from Unit 1." },
  ],
  ...
  "range-hood": [
    { id: "img001", imageUrl: "/images/img-1-HVAC-kitchen-exhaust.webp", title: "Unit 1 range hood", shortAnnotation: "Unit 1 range hood", fullAnnotation: "Range hood: Broan MTT130SS with its fan removed and controls modified to add a variable speed switch, Fantech WC15. See Drawing H-6 for schematic." },
    { id: "img002", imageUrl: "/images/img-2-HVAC-kitchen-exhaust.webp", title: "Unit 1 exterior exhaust fan", shortAnnotation: "Unit 1 exterior exhaust fan", fullAnnotation: "Exhaust fan: Fantech RVF 6XL from the range hood via a 7 in. duct. See drawing H-4, HVAC Attic Plan." },
    { id: "img003", imageUrl: "/images/img-3-HVAC-kitchen-exhaust.webp", title: "Unit 2 range hood", shortAnnotation: "Unit 2 range hood", fullAnnotation: "Range hood: Broan MTT130SS with its fan removed and controls modified to add a variable speed switch, Fantech WC15. See Drawing H-6 for schematic." },
    { id: "img004", imageUrl: "/images/img-4-HVAC-kitchen-exhaust.webp", title: "Unit 2 exterior exhaust fan", shortAnnotation: "Unit 2 exterior exhaust fan and ERV exhaust", fullAnnotation: "Exhaust fan: Fantech RVF 6XL from the range hood via a 7 in. duct. See drawing H-4, HVAC Attic Plan." },
  ],
  ...
  "ice-dams": [
    ...
    { id: "img006", imageUrl: "/images/img-06-ice-dams.webp", title: "overframed addition", shortAnnotation: "", fullAnnotation: "Next, the ell addition was framed atop of the insulated main roof deck." },
    { id: "img007", imageUrl: "/images/img-07-ice-dams.webp", title: "soffit vent channel intakes within heated space", shortAnnotation: "", fullAnnotation: "And, heated air was leaking from above the ceilings of the ell through the vent to the ridge." },
  ...
  "solar": [
    { id: "img01", imageUrl: "/images/img-01-solar.webp", title: "Mounting rails installed", shortAnnotation: "", fullAnnotation: "rail feet fastened to structural 2x4s" },
    { id: "img02", imageUrl: "/images/img-02-solar.webp", title: "'Laying glass' begins", shortAnnotation: "", fullAnnotation: "" },
    { id: "img03", imageUrl: "/images/img-03-solar.webp", title: "Hoisting panels", shortAnnotation: "", fullAnnotation: "" },
    { id: "img04", imageUrl: "/images/img-04-solar.webp", title: "Main roof completed", shortAnnotation: "", fullAnnotation: "" },
    { id: "img05", imageUrl: "/images/img-05-solar.webp", title: "Last Panel of 19", shortAnnotation: "", fullAnnotation: "" },
    { id: "img06", imageUrl: "/images/img-06-solar.webp", title: "Inverter", shortAnnotation: "", fullAnnotation: "" },
    { id: "img07", imageUrl: "/images/img-07-solar.webp", title: "Completed array", shortAnnotation: "", fullAnnotation: "" },
    { id: "img08", imageUrl: "/images/img-08-solar.webp", title: "Completed inverter", shortAnnotation: "", fullAnnotation: "" },
  ],
