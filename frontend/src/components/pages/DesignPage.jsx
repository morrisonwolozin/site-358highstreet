  ...
  return (
    <div className="max-w-5xl mx-auto space-y-10">
      ...
      <PageIntro  
          ...
          >
          <p className="text-base py-1 text-gray-700">The design scope addressed the building's physical and functional deficiencies, added new spaces, electrified heating systems and delivered a 'deep energy' retrofit. The project goals were to offer a superior tenant experience through complete separation of all functions and utilities, low utility operating expenses and verifiably good, i.e., montitored, indoor air quality.</p>
          <p className="text-base py-1 text-gray-700">See below on this page for details: thermal envelope retrofit, pre- and post-air leakage tests, Efficiency Maine incentives, pre- and post-Rvalues and HVAC load calculations.</p> 
         </PageIntro>
