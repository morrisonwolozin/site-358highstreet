    ...
    <div className="max-w-5xl mx-auto gap-y-4">
      ...
      >
        ...
        <p className="text-base py-1 text-gray-700">
          ...
          an abutter, and the mortgage company. See the{" "}
          <a
            href="/downloads"
          ...
          on the Downloads page for the agreement. The photo gallery
          below includes the original 2004 modulular construction 'nameplates'.
        </p>
      </PageIntro>
