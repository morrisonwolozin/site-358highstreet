  ...
  return (
    <div className="max-w-5xl mx-auto gap-y-4">
      <PageIntro
        ...
        tableData={{
            caption: "Loads and Capacities",
            headers: ["Location", "Heating Load (MBH)", "Heating Capacity (MBH)", "Notes"],
            rows: [
              ["Apartment 1", "12.6", "16.5","includes crawlspace, storage"],
              ["Apartment 2", "12.2", "16.5","includes crawlspace, storage"],
            ]}}
      >
        ...
        <p className="text-base text-gray-700"> Each system's indoor unit and distribution ductwork is located in its crawlspace </p>
        <p className="text-base text-gray-700"> The systems are controlled with Mitsubishi MHK-2 thermostats. There's remote access to the systems via kumo Cloud. </p>
      </PageIntro>
